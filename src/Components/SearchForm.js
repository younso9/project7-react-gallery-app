...
// Resource: https://reacttraining.com/react-router/core/api/withRouter
...
class SearchForm extends Component {
  ...
  handleSubmit(e) {
    // This method cancels the event preventing the default action that belongs to the event from occurring.
    e.preventDefault();

    // This allows for the users inquiry to get rendered as a search
    this.props.history.push(`/gallery/${this.state.searchTerm}`);

    // This will reset button to its normal state
    e.currentTarget.reset();
  }

  render() {
    return (
      // This renders the search form, with a button and input field
